...
MCE processes Finnish text through four computational machines, each grounded in a different mathematical model. The entire system compiles to a 225KB WASM module that runs offline in the browser.
